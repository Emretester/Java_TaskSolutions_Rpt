...
/*
        ...
        String wantToReserve = scan.next().toLowerCase();
        String result = "";

        while (!(wantToReserve.equals("yes") || wantToReserve.equals("no"))) {
            System.out.println("Invalid answer, please re-enter(yes/no):");
            wantToReserve = scan.next().toLowerCase();
        }

        scan.nextLine();

        if (wantToReserve.equals("no")) {
